...
- [ ] **Topics/Tags**: Add 5-10 relevant topics (e.g., `python`, `tui`, `textual`, `factory-ai`, `dashboard`)
- [ ] **Website URL**: Link to documentation site (izikeros.github.io/droid-dash)
...
[![codecov](https://codecov.io/gh/izikeros/droid-dash/branch/main/graph/badge.svg)](https://codecov.io/gh/izikeros/droid-dash)
[![PyPI version](https://badge.fury.io/py/droid-dash.svg)](https://badge.fury.io/py/droid-dash)
[![Downloads](https://pepy.tech/badge/droid-dash)](https://pepy.tech/project/droid-dash)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Documentation](https://img.shields.io/badge/docs-GitHub%20Pages-blue)](https://izikeros.github.io/droid-dash)
```
...
- [ ] **Twitter/X**: Tweet with relevant hashtags (#Python #TUI #FactoryAI)
- [ ] **LinkedIn**: Professional announcement post
- [ ] **Reddit**: Post to r/Python, r/commandline (follow rules)
